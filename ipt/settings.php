  ...
  <div class="profile-container">
    ...
    <div class="tab-content" id="privacyTab">
      ...
      <div class="settings-section">
        ...
        <button type="button" class="cancel-btn" style="width: 100%; margin-bottom: 10px;">
          Change Password
        </button>
        <button type="button" class="cancel-btn" style="width: 100%; background: #f8d7da; color: #721c24;">
          Delete Account
        </button>
      </div>
    </div>
