    ...
    <div class="tab-content" id="privacyTab">
      <div class="settings-section">
        ...
        <label style="display: flex; align-items: center;">
          <input type="checkbox" name="private_account" style="width: auto; margin-right: 10px; accent-color: #9c6b3e;">
          Make my account private
        </label>
        <label style="display: flex; align-items: center;">
          <input type="checkbox" name="hide_email" style="width: auto; margin-right: 10px; accent-color: #9c6b3e;">
